...
exports.signup = exports.sellersignup = exports.logout = exports.login = void 0;
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee3(name, email, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://127.0.0.1:3000/api/v1/users/sellerSignup',
              data: {
                name: name,
                email: email,
                password: password,
  ...
  return function sellersignup(_x7, _x8, _x9, _x10) {
...
var sellerSignupForm = document.querySelector('.form--seller');
console.log(sellerSignupForm); // DELEGATION
...
if (sellerSignupForm) console.log("Hello");
sellerSignupForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  ...
  (0, _login.sellersignup)(name, email, password, passwordConfirm);
});
